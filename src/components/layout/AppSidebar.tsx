            ...
            <Collapsible key={group.label} className="group/group mb-1" defaultOpen={isGroupActive}>
              <SidebarGroup className="px-2">
                <SidebarGroupLabel asChild>
                  <CollapsibleTrigger className="flex items-center gap-3 text-sm font-semibold text-sidebar-foreground hover:text-sidebar-primary transition-all cursor-pointer w-full touch-manipulation active:scale-95 py-3 px-3 mb-1 rounded-lg bg-primary/10 hover:bg-primary/15 group-data-[collapsible=icon]:justify-center">
